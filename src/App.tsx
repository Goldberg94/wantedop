            ...
            <div className="bg-[rgba(15,15,25,0.6)] backdrop-blur-md rounded-lg sm:rounded-xl p-4 sm:p-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input 
                    type="text"
                    className="w-full p-3 sm:p-4 bg -[#374151] border-none rounded-lg sm:rounded-xl text-white placeholder-gray-400"
                    value={rawName}
                ...
                <div>
                  ...
                  <input 
                    type="number"
                    className="w-full p-3 bg-[#374151] border-none rounded-xl text-white placeholder-gray-400"
                    value={bounty}
                ...
                <button 
                  ...
                  className="w-full bg-[#8B5CF6] text-white p-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#7C3AED] transition-colors mt-8"
                >
